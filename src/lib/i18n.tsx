...
const dict = {
  pt: {
    ...
    "lang.label": "Idioma",
    "lead.title": "Fique por dentro dos novos imóveis",
    "lead.subtitle": "Deixe seu e-mail e receba, sem pressa e sem excessos, as novidades selecionadas.",
    "lead.placeholder": "seu@email.com",
    "lead.submit": "Quero receber novidades",
    "lead.close": "Fechar",
    "lead.success": "Obrigado! Em breve você receberá novidades.",
    "lead.invalid": "Informe um e-mail válido.",
    "lead.error": "Não foi possível salvar agora. Tente novamente.",
  },
  en: {
    ...
    "lang.label": "Language",
    "lead.title": "Stay up to date on new properties",
    "lead.subtitle": "Leave your email and receive curated updates, without any noise.",
    "lead.placeholder": "you@email.com",
    "lead.submit": "Keep me posted",
    "lead.close": "Close",
    "lead.success": "Thank you! You will hear from us soon.",
    "lead.invalid": "Please enter a valid email.",
    "lead.error": "We could not save it right now. Please try again.",
  },
  es: {
    ...
    "lang.label": "Idioma",
    "lead.title": "Entérate de los nuevos inmuebles",
    "lead.subtitle": "Deja tu correo y recibe novedades seleccionadas, sin excesos.",
    "lead.placeholder": "tu@email.com",
    "lead.submit": "Quiero recibir novedades",
    "lead.close": "Cerrar",
    "lead.success": "¡Gracias! Pronto recibirás novedades.",
    "lead.invalid": "Introduce un correo válido.",
    "lead.error": "No se pudo guardar ahora. Inténtalo de nuevo.",
  },
} as const;
